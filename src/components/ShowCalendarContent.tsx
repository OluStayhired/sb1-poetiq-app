...
// Specific HookpostV3 for Bluesky 
const handleBlueskyHookPostV3 = async (content: CalendarContent, char_length: string) => {
...
// End Bluesky HookPostV3 Version  
      ...
      return(
        ...
        <div className="flex flex-col items-start mb-4">  {/*start AI Buttons Here */}
              ...
              <button
                ...
                onClick={() => handleBlueskyHookPostV3(content, 300)}
