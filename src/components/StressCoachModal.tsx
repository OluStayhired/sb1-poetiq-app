// src/components/StressCoachModal.tsx
...
import { getStressCoach } from '../lib/geminiStressCoach';
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      //const conversationSummary = messages
       // .map(m => `${m.role === 'user' ? 'You' : 'Sophia'}: ${m.content}`)
        //.join('\n\n');
            ...
            />
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm border border-red-100 duration-500 hover:border-red-200 hover:shadow-md">
                <p className="text-sm text-gray-700 leading-relaxed hover:text-red-600 duration-500">
                  {/*
                  Hey there I'm Sophia! I know how hard it is to navigate long term care insurance. 
                  ...
                  */} 
                  I help career professionals avoid conflicts and manage family stresses that come from caregiving disagreements.
                </p>
              </div>
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-start space-x-2">
                    ...
                    <span 
                        ...
                        onClick={() => handleMedicaidTopic("Understanding What Causes Conflict")}
                    >
                        Understanding What Causes Conflict
                    </span>
                    </TooltipHelp>
                  ...
                  <li className="flex items-start space-x-2">
                    ...
                    <span 
                        className="hover:text-red-500 duration-500 cursor-pointer"
                        onClick={() => handleMedicaidTopic("Offering Advice without Causing Offence")}
                    >
                        Offering Advice without Causing Offence
                    </span>
                    </TooltipHelp>
                  ...
                  <li className="flex items-start space-x-2">
                    ...
                    <span 
                        className="hover:text-red-500 duration-500 cursor-pointer"
                        onClick={() => handleMedicaidTopic("Navigating Financial Resentment")}
                    >
                        Navigating Financial Resentment
                    </span>
                    </TooltipHelp>
                  ...
                  <li className="flex items-start space-x-2">
                    ...
                    <span 
                        className="hover:text-red-500 duration-500 cursor-pointer"
                        onClick={() => handleMedicaidTopic("Avoiding the Betrayal Narrative")}
                    >
                        Avoiding the betrayal narrative
                    </span>
                    </TooltipHelp>
                  ...
                  <li className="flex items-start space-x-2">
                    ...
                    <span 
                        className="hover:text-red-500 duration-500 cursor-pointer"
                        onClick={() => handleMedicaidTopic("Managing Communication Breakdowns")}
                    >
                        Managing communication breakdowns
                    </span>
                    </TooltipHelp>
                  ...
                  <li className="flex items-start space-x-2">
                    <span className="text-red-500 mt-0.5">•</span>
                    <TooltipExtended text="⚡ For more on managing inheritance conflicts join Poetiq. Get connected to caregiving conflict Experts in our network">
                    <span className="text-gray-300 hover:text-red-500 duration-500">Dealing with inheritance conflicts</span>
                    </TooltipExtended>  
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-red-500 mt-0.5">•</span>
                    <TooltipExtended text="⚡ For more on avoiding caregiver abandonment join Poetiq. Get connected to the Experts in our network">
                    <span className="text-gray-300 hover:text-red-500 duration-500">Avoiding family caregiver abandonment</span>
                    </TooltipExtended> 
                  </li>
                   <li className="flex items-start space-x-2">
                    <span className="text-red-500 mt-0.5">•</span>
                    <TooltipExtended text="⚡ For more on approaching end-of-life caregiving conflicts join Poetiq. Get connected to the Experts in our network">
                    <span className="text-gray-300 hover:text-red-500 duration-500">End-of-Life caregiving conflicts</span>
                    </TooltipExtended> 
                  </li>
                </ul>
              </div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {messages.map((message) => (
                ...
                >
                  {/* Avatar for Sophia (assistant messages only) */}
                ...
                <div className="flex justify-start">
                  <div className="bg-gray-100 rounded-lg p-4 border border-gray-200">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-600">Sophia is typing...</span>
                    </div>
                  </div>
                </div>
              )}
...
export default StressCoachModal;
